			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ddinven-display": {
								"semanticObject": "ddinven",
								"action": "display",
								"description": "실재고 및 유통기한 정보 조회 어플리케이션",
								"title": "재고 조회 어플리케이션",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ddinven",
									"url": sap.ui.require.toUrl("ddinven")
								}
							}
						}
					}
