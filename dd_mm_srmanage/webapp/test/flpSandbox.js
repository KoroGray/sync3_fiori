		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#ddmmsrmanage-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ddmmsrmanage-display": {
								"semanticObject": "ddmmsrmanage",
								"action": "display",
								"description": "수불대장 조회 어플리케이션",
								"title": "App Title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ddmmsrmanage",
									"url": sap.ui.require.toUrl("ddmmsrmanage")
								}
							}
						}
					}
