sap.ui.define([
    ...
    function (Controller, Fragment, Filter) {
        ...
        return Controller.extend("odata.project0507.controller.Main", {
            onInit: function () {
            ...
            onValueHelp: function() {
                ...
                if(!oDialog) {
                    Fragment.load({
                        name : 'odata.project0507.view.Fragment.Customer',
                        type : 'XML',
                        controller : this
            ...
            onSearch: function() {
                ...
                var cFilter = new Filter('CustomerID', 'EQ', oData.CustomerID);
                if(oData.OrderDateFrom && oData.OrderDateTo){
                var dFilter = new Filter('OrderDate', 'BT', oData.OrderDateFrom, oData.OrderDateTo)
                };
