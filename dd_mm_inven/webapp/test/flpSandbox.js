			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ddmminven-display": {
								"semanticObject": "ddmminven",
								"action": "display",
								"description": "술독 재고 조회 어플리케이션",
								"title": "App Title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ddmminven",
									"url": sap.ui.require.toUrl("ddmminven")
								}
							}
						}
					}
