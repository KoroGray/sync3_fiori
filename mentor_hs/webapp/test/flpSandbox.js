		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori Mentor",
									"targetURL": "#mentormentorhs-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mentormentorhs-display": {
								"semanticObject": "mentormentorhs",
								"action": "display",
								"description": "Fiori Mentor",
								"title": "Fiori Mentor",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=mentor.mentorhs",
									"url": sap.ui.require.toUrl("mentor/mentorhs")
								}
							}
						}
					}
